...
public class OgLog {
    ...
    public static OgLog getOgLog(FightOpty bisOgLog, String url, Object headerMessage,
                                 Object requestMessage, Object responseMessage, String error, long runtime) {
        
        OgLog ogLog = new OgLog();
        ogLog.setOptType(bisOgLog.getOptType());
        ogLog.setRequestId(bisOgLog.getRequestId());
        ogLog.setUrl(url);
